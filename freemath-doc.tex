...
The package provides the \verb|\freemathon| and \verb|\freemathoff| commands which respectively activate and deactivate this behaviour. It is enabled by default upon loading by \verb|\usepackage{freemath}|.
